...
_ledger.logWorkerEvidence("system", "online", "Autonomous worker runtime initialization cycle verified.");
// -----------------------------------------------
...
import * as cyberWorker from "./public-worker/index.js";

// Worker imports (you already have these)
import { publicWorker } from "./public-worker/index.js";
