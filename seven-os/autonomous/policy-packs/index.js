...
import ogeMisconduct from "../../policy-packs/sovereign/oge-misconduct.json" assert { type: "json" };
import ombM1406 from "../../config/omb-m14-06.json" assert { type: "json" };
import ombM2012 from "./sovereign/omb-m20-12.json" assert { type: "json" };
import ostpIntegrity from "../../config/ostp-scientific-integrity.json" assert { type: "json" };
