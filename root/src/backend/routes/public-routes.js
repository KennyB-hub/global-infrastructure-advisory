// Add this to your map logic in backend/routes/
if (!jwt) {
  // PUBLIC VIEW: Return only generalized, low-res data
  return new Response(JSON.stringify({
    layerName: "Public-Activity-Mask",
    region: "Global",
    coordinates: "REDACTED", // No exact points for the public
    activeZones: ["Sector A", "Sector D"] // Only general areas
  }));
}
